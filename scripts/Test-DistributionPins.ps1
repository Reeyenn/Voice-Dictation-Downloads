...
Assert-Contains $workflow 'VersionInfo.FileVersion' 'Public workflow'
Assert-Contains $workflow '6.7.1.0' 'Public workflow'
Assert-Contains $workflow '.Trim()' 'Public workflow'
